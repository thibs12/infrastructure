...
- Penser également à configurer le backend terraform en créant un bucket S3 et une table dynamoDB pour le lock. Puis référencer le bucket dans le block 'backend' de terraform pour les deux configurations (avec une clé différente).
